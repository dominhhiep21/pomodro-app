package thong.kotlin.pomodoro.features.background.data
...
object BackgroundRepository {
    val availableBackgrounds = listOf(
        AppBackground(
            "cyberpunk",
            "Cyberpunk",
            Res.drawable.cyberpunk_bg,
            Res.drawable.landscape_cyberpunk_bg
        ),
        AppBackground(
            "forest",
            "Rừng già",
            Res.drawable.forest_bg,
            Res.drawable.landscape_forest_bg
        ),
        AppBackground("ocean", "Đại dương", Res.drawable.ocean_bg, Res.drawable.lanscape_ocean_bg),
        AppBackground(
            "classic",
            "Mặc định",
            Res.drawable.startup_bg,
            Res.drawable.landspace_startup_bg
        )
    )
